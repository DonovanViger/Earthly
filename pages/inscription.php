...
<body id="body_inscription">
    ...
    <div id="inscription_files_box">
        ...
        <label for="photo" class="custom-file-input"><img src="../img/dossier.svg" id="inscription_dossier_svg">
            <p id="inscription_paragraph_dossier">Choisir un fichier</p>
        </label>
    ...
    document.getElementById("inscription_form").addEventListener("submit", function(event) {
        ...
        if (pseudo.length > 25) {
            alert("Le pseudo ne doit pas dépasser 25 caractères !");
